    ...
    <section id="programs" className="relative z-30 mx-auto -mt-16 max-w-7xl scroll-mt-24 px-6 pb-20 md:px-12">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="flex min-h-[220px] flex-col justify-between rounded-2xl bg-[#e8d9b8] p-8 md:p-9">
          ...
          <Link
            href="/login"
            className="mt-6 w-fit rounded-full bg-white px-6 py-2.5 text-sm font-medium text-[#3f2e1e] transition-colors hover:bg-[#3f2e1e] hover:text-white"
          >
            Donate
          </Link>
        </div>
        ...
        <div className="relative flex min-h-[220px] items-end overflow-hidden rounded-2xl">
          ...
          <div className="relative z-10 p-8 text-white md:p-9">
            ...
            <Link
              href="/login"
              className="inline-block rounded-full bg-white px-6 py-2.5 text-sm font-medium text-black transition-colors hover:bg-white/90"
            >
              Donate
            </Link>
          </div>
        ...
        <div className="flex min-h-[220px] flex-col justify-between rounded-2xl bg-brand-sage p-8 text-white md:p-9">
          ...
          <Link
            href="/register"
            className="mt-6 w-fit rounded-full bg-white px-6 py-2.5 text-sm font-medium text-[#2e5c42] transition-colors hover:bg-white/90"
          >
            Join
          </Link>
        </div>
