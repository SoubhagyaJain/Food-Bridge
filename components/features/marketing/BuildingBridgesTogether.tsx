...
export function BuildingBridgesTogether() {
  return (
    <section id="about" className="mx-auto max-w-7xl scroll-mt-24 bg-white px-6 py-16 md:px-12 md:py-20">
          ...
          <div id="impact" className="mt-10 grid grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-2xl font-semibold text-gray-900 sm:text-3xl">{stat.value}</div>
